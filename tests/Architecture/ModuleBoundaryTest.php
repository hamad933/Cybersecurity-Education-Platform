...
class ModuleBoundaryTest extends TestCase
{
    ...
    public function raw_table_writes_stay_with_the_owning_module(): void
    {
        $ownership = [
            ...
            'Enterprise' => ['enterprise_baseline_revisions', 'improvement_proposals', 'simulation_enterprises', 'simulation_digital_twins', 'simulation_digital_twin_revisions', 'simulation_baselines'],
            'Simulator' => ['simulator_rule_revisions', 'scenario_revisions', 'scenario_runs', 'decision_traces', 'replay_records', 'vs003_telemetry_dataset_revisions', 'vs003_investigation_cases', 'vs003_investigation_alerts', 'vs003_triage_records', 'simulation_scenario_definitions', 'simulation_lab_definitions', 'simulation_scenario_lab_references', 'simulation_runs', 'simulation_run_operations', 'simulation_run_lab_module_instances', 'simulation_run_events', 'simulation_runtime_snapshots', 'simulation_runtime_checkpoints', 'simulation_run_results', 'simulation_result_replay_compares', 'simulation_candidate_evidence_handoffs'],
            'Evidence' => ['evidence_records', 'evidence_decisions', 'imported_evidence_records', 'vs003_custody_events', 'vs003_containment_proposals', 'vs003_control_revisions', 'vs003_verification_replays', 'evidence_source_handoff_receipts', 'evidence_candidates', 'evidence_candidate_intake_events', 'evidence_admission_records', 'governed_evidence', 'governed_evidence_revisions', 'evidence_review_requests', 'evidence_review_scope_items', 'evidence_reviews', 'evidence_review_findings', 'evidence_review_decisions', 'evidence_review_decision_items', 'evidence_mastery_policies', 'evidence_mastery_policy_revisions', 'evidence_mastery_evaluations', 'evidence_mastery_states', 'evidence_mastery_state_decisions', 'evidence_mastery_state_evidence', 'evidence_portfolios', 'evidence_portfolio_items'],

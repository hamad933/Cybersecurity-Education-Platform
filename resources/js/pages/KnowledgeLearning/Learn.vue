...
const visualizeHref = computed(() =>
  props.active
    ? `/knowledge/visualize?object=${encodeURIComponent(props.active.id)}`
    : '/knowledge/visualize',
);
</script>
        ...
        >
          ...
          >
            ...
            <div class="mt-3 flex-1 space-y-2 overflow-y-auto pr-0.5 text-xs">
              <div v-if="journey.items.length" class="space-y-1.5">
                ...
                <div class="mt-3 flex flex-wrap items-start justify-between gap-4">
                  <div class="min-w-0">
                    ...
                    <p class="mt-2 max-w-2xl text-sm leading-relaxed text-slate-400">
                      ...
                      >. العقد الحالي يقدّم وحدة المعرفة (Knowledge Unit) وحالة الأنشطة فقط، ولا
                      يقدّم كائن درس مسجل.
                    </p>

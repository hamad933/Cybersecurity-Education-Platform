      ...
      <div class="w-full px-0 py-3 sm:px-4 xl:px-6">
        ...
        >
            ...
            <div class="border-b border-slate-800/80 pb-4">
              ...
              <div class="mt-3 space-y-2 rounded-xl border border-slate-800 bg-slate-950/60 p-3">
                ...
                <div class="flex items-center justify-between gap-2 text-xs">
                  ...
                  <bdi dir="ltr" class="font-mono font-bold text-cyan-300">{{
                    mapScope ?? '—'
                  }}</bdi>
                </div>
              </div>
              <p class="mt-3 text-[11px] leading-relaxed text-slate-400">
                <bdi dir="ltr" class="font-bold text-slate-300">MAP</bdi> يحفظ النطاق ومعلومات
                التمثيل فقط، ولا يصبح مخزنًا ثانيًا للعقد أو العلاقات القانونية.
              </p>
            </div>
          ...
          >
            ...
            <section class="mt-6 border-t border-slate-800/80 pt-4">
              ...
              <bdi dir="ltr" class="mt-2 block font-mono text-[11px] break-all text-slate-400">
                {{ graph.source }}
              </bdi>
            </section>
          </aside>
        ...
        >
          ...
          <div class="mt-4 max-h-48 space-y-2 overflow-y-auto pr-0.5">
            ...
            <p v-if="!graph.edges.length" class="text-xs text-slate-500">
              لا يوجد أثر علاقات محفوظ.
            </p>
          </div>
        </details>
      </div>
